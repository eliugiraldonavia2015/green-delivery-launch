      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16 animate-fade-in">
          <div className="inline-block px-4 py-2 bg-primary/10 border border-primary/20 rounded-full mb-6">
            <span className="text-primary font-semibold">Más Información</span>
          </div>
        ...
        <div className="max-w-3xl mx-auto p-12 rounded-3xl bg-gradient-to-br from-primary/10 via-card to-transparent border border-primary/20 text-center animate-fade-in">
